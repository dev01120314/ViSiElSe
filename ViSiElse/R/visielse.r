#' The function \code{visielse} plot the graphis from data and build an object class
...
#' @param book  A \code{data.frame} or a \code{ViSibook}. \code{book} must correspond to a ViSibook.
#' It stores the process structure.
#' @param doplot logical If FALSE the graphic is not plotted.
#' @param is.ViSibook logical, FALSE if book is a data.frame, TRUE is boo is a ViSIbook.
